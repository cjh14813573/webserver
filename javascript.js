...
window.onload=function(){
    var headers=$("headlist").getElementsByTagName("li");
    var pointers=$("pointer").getElementsByTagName("li");
    var details=new Array();
    details[0]=document.getElementById("detail-1");
    details[1]=document.getElementById("detail-2");
    details[2]=document.getElementById("detail-3");
    for(var i=0;i<headers.length;i++){
        headers[i].number=i;
        headers[i].onclick=function(){
           for(var j=0;j<headers.length;j++){
               pointers[j].style.visibility="hidden";
               details[j].style.display="none";
           }
            pointers[this.number].style.visibility="visible";
            details[this.number].style.display="block";
        }
    }
}
...
function help(){
    window.open("http://"+location.hostname+":"+location.port+"/help.html","_blank","");
}
function minorVersionUpgrade(){
    document.getElementById("upgrade-1").submit();
}
function majorVersionUpgradeAll(){
  //  document.getElementById("upgrade-2").submit();
}
